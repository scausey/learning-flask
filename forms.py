...
class SignupForm(Form):
	...
	last_name = StringField('Last name', validators=[DataRequired("Please etner your last name.")])
...
class LoginForm(Form):
	...
	password = PasswordField('Password', validators=[DataRequired("Please etner a password.")])
